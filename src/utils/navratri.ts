...
export const PASS_TIER_OPTIONS: {
...
}[] = [
  {
    ...
    label: 'Gold',
    emoji: '🟡',
    blurb: 'Full floor access · classic Garba night (Included in base bundle)',
    perks: ['General ras floor access', 'Standard entry window', 'Included in base bundle (Value ₹699–₹1,199/night)'],
    fromPrice: 0,
  },
  {
    id: 'diamond',
    label: 'Diamond',
    emoji: '💎',
    blurb: 'Better circle · priority entry (+₹199 add-on)',
    perks: ['Priority gate entry', 'Inner circle raas zone', 'Water station access'],
    fromPrice: 199,
  },
  {
    id: 'platinum',
    label: 'Platinum',
    emoji: '👑',
    blurb: 'VIP lounge · soft seating (+₹499 add-on)',
    perks: ['Fast-track VIP entry', 'Soft seating / elevated lounge', 'Complimentary welcome drink & snack'],
    fromPrice: 499,
  },
]
